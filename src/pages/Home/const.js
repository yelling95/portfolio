...
export const scopes = [
  ...
  },
  {
    ...
    개발자로써 수행할 수 있는 개발 능력은 물론이고, 동료 개발자들과의 좋은 시너지를 만들어 높은 퀄리티로 일정내 납기를 할 수 있는 개발자가 되기 위해 항상 노력중입니다.`,
  },
  {
    title: '개발자 교육 및 양성',
    ...
    저는 개발자분들을 교육하고 양성하는 업무가 즐겁습니다. 앞으로도 다양한분들은 만나 좀 더 체계적인 방법을 만들어가고 싶습니다.
    `,
  },
  {
    title: '서버 및 인프라 관리',
    ...
    네트워크에 대한 이해가 깊다고 자부할 수는 없지만 전체적인 개념과 용도를 알고 있어, 서비스에 문제가 발생했을때 개발소스 범주 밖에 여러 다양한 이슈들을 고려할 수 있는 시야를 가졌습니다.<br/>
